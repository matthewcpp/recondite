...
void ruiDemoController::Init(ruiOverlay* overlay, rEngine* engine){
	...
	m_modelPicker = new ruiPicker(models, "100", engine, rPoint(25, 10));

	//m_modelPicker->Bind(ruiEVENT_PICKER_CHANGE, this, &ruiDemoController::OnModelChange);

	m_animationPicker = new ruiPicker("101", engine, rPoint(25, 60));
	//m_animationPicker->Bind(ruiEVENT_PICKER_CHANGE, this, &ruiDemoController::OnAnimationChange);

	m_animationTime = new ruiText("0.0", "102", engine, rPoint(25, 110));

	ruiButton* playButton = new ruiButton("Play", "103", engine, rPoint(25, 160));
	ruiButton* pauseButton = new ruiButton("Pause", "104",  engine, rPoint(135, 160));
	ruiButton* stopButton = new ruiButton("Stop", "105", engine, rPoint(245, 160));
	...
	m_progressSlider = new ruiSlider("106", engine, rPoint(145, 110));
